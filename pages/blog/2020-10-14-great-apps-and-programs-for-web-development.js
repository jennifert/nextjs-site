...
export const POST_TITLE = 'Great apps and programs for web development';
export const POST_DESCRIPTION = 'A updated list of different applications that you an use to create your projects in. Separate for paid, free, and subscriptions.';
export const POST_TAGS = ['lists', 'tips','programs']
...
export default function DevPrograms() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2020-10-14'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2020-10-14-great-apps-and-programs-for-web-development'}
                />
            </Head>
