...
export const POST_TITLE = 'Using iOS and Android devices together';
export const POST_DESCRIPTION = 'Using an Android in an Apple environment can be a bit tricky, but here are some tricks and resources to help you out.';
export const POST_TAGS = ['ios', 'android', 'tips']
...
export default function AndroidAndIos() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2025-07-10'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2025-07-10-using-ios-and-android-together'}
                />
            </Head>
