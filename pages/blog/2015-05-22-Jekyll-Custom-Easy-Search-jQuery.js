...
export const POST_TITLE = 'Jekyll: Easy searching with JSON and jQuery';
export const POST_DESCRIPTION = 'This post will describe how to create one a basic search using JSON and jQuery.';
export const POST_TAGS = ['jekyll', 'javascript', 'json']
...
export default function JekyllSearchJSONjQuery() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2015-05-22'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2015-05-22-Jekyll-Custom-Easy-Search-jQuery'}
                />
            </Head>
