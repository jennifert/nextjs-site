...
export const POST_TITLE = 'Raspberry Pi: List of Projects and resource';
export const POST_DESCRIPTION = 'This post contains a list of resources and tips and tricks found while putting together my Raspmbc media centre.';
export const POST_TAGS = ['pi', 'projects']
...
export default function PiProjects() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2013-09-05'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2013-09-05-raspberry-pi-list-of-projects-and-resources'}
                />
            </Head>
