    ...
    return (
        <Layout>
            ...
            <section aria-labelledby="main-content">
                ...
                <ul className="list-disc list-inside m-2">
                    <li>
                        <Link href="/blog/2022-06-29-chromebook-dev"><a className="underline focus:ring-2">A Guide for Setting Up a Chromebook for Web Development</a></Link> on <time dateTime="2022-06-30T18:00">June 30, 2022</time>
                    </li>
                    <li>
