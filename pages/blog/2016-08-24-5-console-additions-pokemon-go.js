...
export const POST_TITLE = '5 additions from the console games that would improve Pokemon Go';
export const POST_DESCRIPTION = 'Pokemon Go is a great idea for a game but as someone who has played the console games in the past there are quite a few things that seem to be missing.';
export const POST_TAGS = ['lists', 'pokemon']
...
export default function PokemonConsoleToGo() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2016-08-24'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2016-08-24-5-console-additions-pokemon-go'}
                />
            </Head>
