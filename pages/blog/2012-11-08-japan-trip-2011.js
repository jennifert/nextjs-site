...
export const POST_TITLE = 'Japan Trip 2011: Planning and Tips'
export const POST_DESCRIPTION = 'Useful phrases, transit advice, and budget tips from my 2011 Japan trip.'
export const POST_TAGS = ['travel', 'japan', 'planning', 'tips']
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2012-11-08-japan-trip-2011'}
                />
            </Head>
