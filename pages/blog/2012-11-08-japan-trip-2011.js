    ...
    return (
        <Layout>
            ...
            <section aria-labelledby="main-content">
                ...
                <p>More tips are on the<a href="http://www.independenttraveler.com/travel-tips/travelers-ed/10-ways-to-survive-a-long-haul-flight" rel="nofollow noreferrer"> Independent Traveler's Site</a>.</p>
                <h2>Transit sites to use</h2>
                <p>Note: Tokyo transit systems have the fare based on distance traveled.</p>
                <p>The most useful site I found to use transit in Japan is <a title="hyperdia.com: Japan Transit" href="http://www.hyperdia.com" rel="nofollow noreferrer">hyperdia.com</a>, it has routes, time tables, etc for all transit types (I wish I knew of this site before I went).</p>
                <p><a title="More information on the Japan Rail pass" href="http://www.japanrailpass.net/eng/en001.html" rel="nofollow noreferrer">Japan Rail Pass Information</a> : This is for temporary visitors. It saves money on trains like the shinkansen. This must be bought BEFORE entry into Japan.</p>
                <p>Also, In Tokyo, pick up a 500¥ re-loadable card (the one I used was <a href="http://www.pasmo.co.jp/en/index.html" rel="nofollow noreferrer">Pasmo</a>). 2500¥ (about $25 CAN) got me the card and lasted for three quarters of my time in Tokyo (I only added more to get to the airport).</p>
                ...
                <p>Check out the <a title="View book on Amazon" href="http://www.amazon.ca/gp/product/1741042313/ref=as_li_tf_tl?ie=UTF8&amp;camp=15121&amp;creative=330641&amp;creativeASIN=1741042313&amp;linkCode=as2&amp;tag=jennisportf-20" rel="nofollow noreferrer">Lonely Planet Japanese Phrasebook</a> for more phrases! Its super useful.</p>
