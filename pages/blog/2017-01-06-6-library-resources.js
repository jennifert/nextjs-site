...
export const POST_TITLE = '6 resources that you may find at your local library';
export const POST_DESCRIPTION = 'The library has more services than just book or disc lending. This post describes what can be found in the city of Toronto, Canada.';
export const POST_TAGS = ['tips']
...
export default function LibraryResources() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2017-01-06'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2017-01-06-6-library-resources'}
                />
            </Head>
