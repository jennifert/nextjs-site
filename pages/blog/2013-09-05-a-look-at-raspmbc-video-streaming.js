...
export const POST_TITLE = 'A look at Raspmbc video streaming';
export const POST_DESCRIPTION = 'Outdated: A guide to video streaming on a raspberry pi.';
export const POST_TAGS = ['pi', 'streaming']
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2013-09-05-a-look-at-raspmbc-video-streaming'}
                />
            </Head>
