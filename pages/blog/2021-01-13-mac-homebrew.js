...
export const POST_TITLE = 'Installing Homebrew and Fixing Ruby on your Mac';
export const POST_DESCRIPTION = 'This post describes how to install homebrew, as as well as casks (software applications).';
export const POST_TAGS = ['mac', 'homebrew', 'ruby']
...
export default function MacHomebrew() {
    ...
    const POST_DATE = dateMatch ? dateMatch[1] : '2021-01-13'
        ...
        <Layout>
            <Head>
                ...
                <PostJsonLd
                    ...
                    date={POST_DATE}
                    tags={POST_TAGS}
                    pathname={router?.pathname || '/blog/2021-01-13-mac-homebrew'}
                />
            </Head>
