            ...
            <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                ...
                <div className="lg:flex flex-grow items-center" id="menu-items">
                    ...
                    <ul className="flex flex-col lg:flex-row list-none mr-auto">
                        ...
                        <li className="nav-item">
                            <Link href="/sitemap"><a className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75 no-underline hover:underline focus:ring-2 focus:ring-white">Sitemap</a></Link>
                        </li>
                    </ul>
